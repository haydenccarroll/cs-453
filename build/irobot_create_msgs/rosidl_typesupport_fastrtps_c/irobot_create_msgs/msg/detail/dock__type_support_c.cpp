...
#include "irobot_create_msgs/msg/detail/dock__rosidl_typesupport_fastrtps_c.h"
...
using _Dock__ros_msg_type = irobot_create_msgs__msg__Dock;
...
size_t get_serialized_size_irobot_create_msgs__msg__Dock(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Dock__ros_msg_type * ros_message = static_cast<const _Dock__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Dock__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_irobot_create_msgs__msg__Dock(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_irobot_create_msgs
size_t max_serialized_size_irobot_create_msgs__msg__Dock(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Dock__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_irobot_create_msgs__msg__Dock(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, irobot_create_msgs, msg, Dock)() {
